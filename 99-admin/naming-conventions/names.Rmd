...
*  $b$ is used to denote "before event", generally migration from one location to another or a mortality source 
*  $a$ is used to denote "after event"
...
*  $y$ represents brood year fish were spawned for all non-adult states. For adult states, it is the brood year in which they return
