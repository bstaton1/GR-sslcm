...
post_v_prior_pops = function(post_param, prior_param, legend_loc = "topright", xlim = NULL, is_rho = FALSE, y_max = 0.3, ...) {
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_E_Pb_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_lL_Pb_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lpi_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_Pa_Mb_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_lDelta_L_Pb_Mb_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_Mb_Ma_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_Ma_O0_prior`,`r jags_data$no`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_O0_O1_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lpsi_O1_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lpsi_O2_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_Rb_Ra_prior`,`r jags_data$no`),`r jags_data$isw_df`)`
...
**Prior Used**: `dscaled.wishart(rep(`r jags_data$Tau_Lphi_Sb_Sa_prior`,`r jags_data$nj`),`r jags_data$isw_df`)`
