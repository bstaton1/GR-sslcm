...
L2 = c("BH Productivity", "BH Capacity", "Capacity vs. Habitat Slope", "Capacity vs. slope SD", "White Noise Process SD", "AR(1) Coefficient", "Initial Residual", "Among-pop Correlation", "Realized")
match = c("alpha", "^beta[", "^lambda$", "sig_lbeta", "sig_Lphi_E_Pb", "kappa_phi_E_Pb", "Lphi_E_Pb_resid[1,", "rho_Lphi_E_Pb", "^phi_E_Pb[")
...
L2 = c("Yr1 NOR:HOR Scaler", "Yr2 NOR:HOR Scaler", "Yr1 Initial Residual", "Yr 1 AR(1) Coefficient")
base = c("delta_O0_O1[pop]", "delta_O1_O2[pop]", "Lphi_O0_O1_resid[1,1,pop]", "kappa_phi_O0_O1[pop]")
