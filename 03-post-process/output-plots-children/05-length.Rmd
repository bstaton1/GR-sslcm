...
plot_f = function(j) {
  ...
  plot_tseries(est = post_summ(post, sub_index("^L_Pb[year,pop]", year = ts_yrs, pop = j)), 
               main = pops[j], yrs = all_yrs[ts_yrs], ylim = L_Pb_lim
  )
}
...
plot_f = function(j) {
  plot_tseries(post_summ(post, sub_index("^Delta_L_Pb_Mb[year,pop]$", year = ts_yrs, pop = j)),
               main = pops[j], yrs = all_yrs[ts_yrs], ylim = Delta_L_Pb_Mb_lim)
}
...
plot_f = function(j) {
  ...
  plot_tseries(post_summ(post, sub_index("^Delta_L_Pb_Mb[year,pop]$", year = ts_yrs, pop = j)),
               Delta_L_Pb_Mb_obs, main = pops[j], yrs = all_yrs[ts_yrs], ylim = Delta_L_Pb_Mb_lim)
}
...
plot_f = function(j) {
  ...
  plot_tseries(est = post_summ(post, sub_index("^L_Mb[year,pop]", year = ts_yrs, pop = j)), 
               main = pops[j], yrs = all_yrs[ts_yrs], ylim = L_Mb_lim
  )
}
