...
params:
  ...
  scenario:
    label: "Scenario"
    value: "relate-hat-nat-age-4-5-same"
    input: text
  mcmc_plots:
...
plot_tseries(post_summ(post, "phi_O2_O3[.+,1]$"), main = "O2 -> O3 (Nat)", yrs = as.numeric(rownames(jags_data$Pa_obs)[observable]), ylim = c(0,1))
plot_tseries(post_summ(post, "phi_O2_O3[.+,2]$"), main = "O2 -> O3 (Hat)", yrs = as.numeric(rownames(jags_data$Pa_obs)[observable]), ylim = c(0,1))
