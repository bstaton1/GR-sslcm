...
match = c("alpha", "^beta[", "mu_beta_per_wul", "sig_lbeta", "sig_Lphi_E_Pb", "rho_Lphi_E_Pb", "^phi_E_Pb[", "^Pb[")
...
get_resids = function(post, j) {
  ...
  out = list(
    egg_to_parr_surv = post_summ(post, sub_index("^Lphi_E_Pb_resid[.+,pop]", pop = j))["mean",],
...
```{r rho_plot, fig.width = 6, fig.height = 8}
...
rho_names = c(
  ...
  "rho_Lpi[2,1]" = "Mig. Stategy Apportionment",
  ...
  "rho_Lpsi_O1_Rb[2,1,1]" = "Age-3 Maturation (NOR)",
  "rho_Lpsi_O1_Rb[2,1,2]" = "Age-3 Maturation (HOR)",
  "rho_Lpsi_O2_Rb[2,1,1]" = "Age-4 Maturation (NOR)",
  "rho_Lpsi_O2_Rb[2,1,2]" = "Age-4 Maturation (HOR)"
  )
