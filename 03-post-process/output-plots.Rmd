...
Sig_lPb = suppressMessages(vcov_decomp(post, "Sig_lPb", sigma_base_name = "sig_lPb", rho_base_name = "rho_lPb"))
Sig_Lpi = suppressMessages(vcov_decomp(post, "Sig_Lpi", sigma_base_name = "sig_Lpi", rho_base_name = "rho_Lpi"))
Sig_Lphi_Pa_Mb1 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lphi_Pa_Mb[.,.,1]"), "Sig_Lphi_Pa_Mb", sigma_base_name = "sig_Lphi_Pa_Mb", rho_base_name = "rho_Lphi_Pa_Mb"))
Sig_Lphi_Pa_Mb2 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lphi_Pa_Mb[.,.,2]"), "Sig_Lphi_Pa_Mb", sigma_base_name = "sig_Lphi_Pa_Mb", rho_base_name = "rho_Lphi_Pa_Mb"))
Sig_Lphi_Mb_Ma1 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lphi_Mb_Ma[.,.,1]"), "Sig_Lphi_Mb_Ma", sigma_base_name = "sig_Lphi_Mb_Ma", rho_base_name = "rho_Lphi_Mb_Ma"))
Sig_Lphi_Mb_Ma2 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lphi_Mb_Ma[.,.,2]"), "Sig_Lphi_Mb_Ma", sigma_base_name = "sig_Lphi_Mb_Ma", rho_base_name = "rho_Lphi_Mb_Ma"))
Sig_Lphi_Ma_O0 = suppressMessages(vcov_decomp(post, "Sig_Lphi_Ma_O0", sigma_base_name = "sig_Lphi_Ma_O0", rho_base_name = "rho_Lphi_Ma_O0"))
Sig_Lphi_O0_O1 = suppressMessages(vcov_decomp(post, "Sig_Lphi_O0_O1", sigma_base_name = "sig_Lphi_O0_O1", rho_base_name = "rho_Lphi_O0_O1"))
Sig_Lpsi_O1_Rb1 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lpsi_O1_Rb[.,.,1]"), "Sig_Lpsi_O1_Rb", sigma_base_name = "sig_Lpsi_O1_Rb", rho_base_name = "rho_Lpsi_O1_Rb"))
Sig_Lpsi_O1_Rb2 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lpsi_O1_Rb[.,.,2]"), "Sig_Lpsi_O1_Rb", sigma_base_name = "sig_Lpsi_O1_Rb", rho_base_name = "rho_Lpsi_O1_Rb"))
Sig_Lpsi_O2_Rb1 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lpsi_O2_Rb[.,.,1]"), "Sig_Lpsi_O2_Rb", sigma_base_name = "sig_Lpsi_O2_Rb", rho_base_name = "rho_Lpsi_O2_Rb"))
Sig_Lpsi_O2_Rb2 = suppressMessages(vcov_decomp(rm_index(post, "Sig_Lpsi_O2_Rb[.,.,2]"), "Sig_Lpsi_O2_Rb", sigma_base_name = "sig_Lpsi_O2_Rb", rho_base_name = "rho_Lpsi_O2_Rb"))
Sig_Lphi_Rb_Ra = suppressMessages(vcov_decomp(post, "Sig_Lphi_Rb_Ra", sigma_base_name = "sig_Lphi_Rb_Ra", rho_base_name = "rho_Lphi_Rb_Ra"))
Sig_Lphi_Sb_Sa = suppressMessages(vcov_decomp(post, "Sig_Lphi_Sb_Sa", sigma_base_name = "sig_Lphi_Sb_Sa", rho_base_name = "rho_Lphi_Sb_Sa"))
...
L2 = c("Mean", "Process SD", "Realized")
base = c("mu_psi_O1_Rb[origin,pop]", "sig_Lpsi_O1_Rb[origin,pop]", "psi_O1_Rb[.+,origin,pop]")
...
L2 = c("Mean", "Process SD", "Realized")
base = c("mu_psi_O2_Rb[origin,pop]", "sig_Lpsi_O2_Rb[origin,pop]", "psi_O2_Rb[.+,origin,pop]")
match = sub_index(base, year = ".+", origin = o_nor, pop = ".")
tmp1 = unlist_dfs(lapply(1:length(match), function(i) diag_fn(match[i], L1 = L1, L2 = L2[i], L3 = "NOR")))
match = sub_index(base, year = ".+", origin = o_hor, pop = ".")
tmp2 = unlist_dfs(lapply(1:length(match), function(i) diag_fn(match[i], L1 = L1, L2 = L2[i], L3 = "HOR")))
...
par(mfrow = c(1,2))
my_boxplot(sub_index("sig_Lpsi_O1_Rb[origin,pop]", origin = o_nor, pop = "."), "", main = "NOR")
my_boxplot(sub_index("sig_Lpsi_O1_Rb[origin,pop]", origin = o_hor, pop = "."), "", main = "HOR")
```
...
par(mfrow = c(1,2))
my_boxplot(sub_index("sig_Lpsi_O2_Rb[origin,pop]", origin = o_nor, pop = "."), "", main = "NOR")
my_boxplot(sub_index("sig_Lpsi_O2_Rb[origin,pop]", origin = o_hor, pop = "."), "", main = "HOR")
```
