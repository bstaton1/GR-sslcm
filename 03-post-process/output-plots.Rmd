...
get_resids = function(post, j) {
  ...
  out = list(
    ...
    age3_mat_nor = post_summ(post, sub_index("^Lpsi_O1_resid[.+,origin,pop]", origin = 1, pop = j))["mean",],
    age3_mat_hor = post_summ(post, sub_index("^Lpsi_O1_resid[.+,origin,pop]", origin = 2, pop = j))["mean",],
    age4_mat_nor = post_summ(post, sub_index("^Lpsi_O2_resid[.+,origin,pop]", origin = 1, pop = j))["mean",],
    age4_mat_hor = post_summ(post, sub_index("^Lpsi_O2_resid[.+,origin,pop]", origin = 2, pop = j))["mean",],
