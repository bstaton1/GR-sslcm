...
```{r known-values, child = "output-plots-children/14-known-values.Rmd", eval = params$include_known}
```

```{r jags-info, child = "output-plots-children/15-jags-model-info.Rmd", eval = params$include_jags_info}
```
